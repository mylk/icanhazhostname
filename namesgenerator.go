...
var persons []Person = []Person{
    Person{
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Maria_Gaetana_Agnesi",},
    },
    Person{
        Name: "albattani",
        Description: "Muhammad ibn Jābir al-Ḥarrānī al-Battānī was a founding father of astronomy.",
        Url: []string{"https://en.wikipedia.org/wiki/Mu%E1%B8%A5ammad_ibn_J%C4%81bir_al-%E1%B8%A4arr%C4%81n%C4%AB_al-Batt%C4%81n%C4%AB",},
    },
    Person{
        Name: "allen",
    ...
    Person{
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Alexander_Graham_Bell",},
    },
    Person{
        Name: "benz",
        Description: "Karl Friedrich Benz. A German automobile engineer. Inventor of the first practical motorcar.",
        Url: []string{"https://en.wikipedia.org/wiki/Karl_Benz",},
    },
    Person{
        Name: "bhabha",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Homi_J._Bhabha",},
    },
    Person{
        Name: "bhaskara",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Bh%C4%81skara_II#Calculus",},
    },
    Person{
        Name: "black",
    ...
    Person{
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Satyendra_Nath_Bose",},
    },
    Person{
        Name: "bouman",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Katie_Bouman",},
    },
    Person{
        Name: "boyd",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Evelyn_Boyd_Granville",},
    },
    Person{
        Name: "brahmagupta",
        Description: "Brahmagupta. Ancient Indian mathematician during 598-670 CE who gave rules to compute with zero",
        Url: []string{"https://en.wikipedia.org/wiki/Brahmagupta#Zero",},
    },
    Person{
        Name: "brattain",
        Description: "Walter Houser Brattain co-invented the transistor",
        Url: []string{"https://en.wikipedia.org/wiki/Walter_Houser_Brattain",},
    },
    Person{
        Name: "brown",
        Description: "Emmett Brown invented time travel.",
        Url: []string{"https://en.wikipedia.org/wiki/Emmett_Brown (thanks Brian Goff)",},
    },
    Person{
        Name: "buck",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Linda_B._Buck",},
    },
    Person{
        Name: "burnell",
        Description: "Dame Susan Jocelyn Bell Burnell. Northern Irish astrophysicist who discovered radio pulsars and was the first to analyse them.",
        Url: []string{"https://en.wikipedia.org/wiki/Jocelyn_Bell_Burnell",},
    },
    Person{
        Name: "cannon",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Annie_Jump_Cannon",},
    },
    Person{
        Name: "carson",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Rachel_Carson",},
    },
    Person{
        Name: "cartwright",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Mary_Cartwright",},
    },
    Person{
        Name: "carver",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/George_Washington_Carver",},
    },
    Person{
        Name: "cerf",
        Description: "Vinton Gray Cerf. American Internet pioneer, recognised as one of \"the fathers of the Internet\". With Robert Elliot Kahn, he designed TCP and IP, the primary data communication protocols of the Internet and other computer networks.",
        Url: []string{"https://en.wikipedia.org/wiki/Vint_Cerf",},
    },
    Person{
        Name: "chandrasekhar",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Subrahmanyan_Chandrasekhar",},
    },
    Person{
        Name: "chaplygin",
        Description: "Sergey Alexeyevich Chaplygin (Russian: Серге́й Алексе́евич Чаплы́гин; April 5, 1869 – October 8, 1942) was a Russian and Soviet physicist, mathematician, and mechanical engineer. He is known for mathematical formulas such as Chaplygin's equation and for a hypothetical substance in cosmology called Chaplygin gas, named after him.",
        Url: []string{"https://en.wikipedia.org/wiki/Sergey_Chaplygin",},
    },
    Person{
        Name: "chatelet",
        Description: "Émilie du Châtelet. French natural philosopher, mathematician, physicist, and author during the early 1730s, known for her translation of and commentary on Isaac Newton's book Principia containing basic laws of physics.",
        Url: []string{"https://en.wikipedia.org/wiki/%C3%89milie_du_Ch%C3%A2telet",},
    },
    Person{
        Name: "chatterjee",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Asima_Chatterjee",},
    },
    Person{
        Name: "chaum",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/David_Chaum",},
    },
    Person{
        Name: "chebyshev",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Pafnuty_Chebyshev",},
    },
    Person{
        Name: "clarke",
    ...
    Person{
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Gerty_Cori",},
    },
    Person{
        Name: "cray",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Seymour_Cray",},
    },
    Person{
        Name: "curran",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Joan_Curran", "https://en.wikipedia.org/wiki/Samuel_Curran",},
    },
    Person{
        Name: "curie",
        Description: "Marie Curie discovered radioactivity.",
        Url: []string{"https://en.wikipedia.org/wiki/Marie_Curie.",},
    },
    Person{
        Name: "darwin",
        Description: "Charles Darwin established the principles of natural evolution.",
        Url: []string{"https://en.wikipedia.org/wiki/Charles_Darwin.",},
    },
    Person{
        Name: "davinci",
        Description: "Leonardo Da Vinci invented too many things to list here.",
        Url: []string{"https://en.wikipedia.org/wiki/Leonardo_da_Vinci.",},
    },
    Person{
        Name: "dewdney",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Alexander_Dewdney",},
    },
    Person{
        Name: "dhawan",
    ...
    Person{
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Paul_Dirac",},
    },
    Person{
        Name: "driscoll",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Agnes_Meyer_Driscoll",},
    },
    Person{
        Name: "dubinsky",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Donna_Dubinsky",},
    },
    Person{
        Name: "easley",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Annie_Easley",},
    },
    Person{
        Name: "edison",
        Description: "Thomas Alva Edison, prolific inventor",
        Url: []string{"https://en.wikipedia.org/wiki/Thomas_Edison",},
    },
    Person{
        Name: "einstein",
        Description: "Albert Einstein invented the general theory of relativity.",
        Url: []string{"https://en.wikipedia.org/wiki/Albert_Einstein",},
    },
    Person{
        Name: "elbakyan",
        Description: "Alexandra Asanovna Elbakyan (Russian: Алекса́ндра Аса́новна Элбакя́н) is a Kazakhstani graduate student, computer programmer, internet pirate in hiding, and the creator of the site Sci-Hub. Nature has listed her in 2016 in the top ten people that mattered in science, and Ars Technica has compared her to Aaron Swartz.",
        Url: []string{"https://en.wikipedia.org/wiki/Alexandra_Elbakyan",},
    },
    Person{
        Name: "elgamal",
    ...
    Person{
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Yuri_Gagarin",},
    },
    Person{
        Name: "galileo",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Galileo_Galilei",},
    },
    Person{
        Name: "galois",
        Description: "Évariste Galois. French mathematician whose work laid the foundations of Galois theory and group theory, two major branches of abstract algebra, and the subfield of Galois connections, all while still in his late teens.",
        Url: []string{"https://en.wikipedia.org/wiki/%C3%89variste_Galois",},
    },
    Person{
        Name: "ganguly",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Kadambini_Ganguly",},
    },
    Person{
        Name: "gates",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Bill_Gates",},
    },
    Person{
        Name: "gauss",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Carl_Friedrich_Gauss",},
    },
    Person{
        Name: "germain",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Sophie_Germain",},
    },
    Person{
        Name: "goldberg",
        Description: "Adele Goldberg, was one of the designers and developers of the Smalltalk language.",
        Url: []string{"https://en.wikipedia.org/wiki/Adele_Goldberg_(computer_scientist)",},
    },
    Person{
        Name: "goldstine",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Adele_Goldstine",},
    },
    Person{
        Name: "goldwasser",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Shafi_Goldwasser",},
    },
    Person{
        Name: "golick",
    ...
    Person{
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Jane_Goodall",},
    },
    Person{
        Name: "gould",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Stephen_Jay_Gould",},
    },
    Person{
        Name: "greider",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Carol_W._Greider",},
    },
    Person{
        Name: "grothendieck",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Alexander_Grothendieck",},
    },
    Person{
        Name: "haibt",
        Description: "Lois Haibt. American computer scientist, part of the team at IBM that developed FORTRAN",
        Url: []string{"https://en.wikipedia.org/wiki/Lois_Haibt",},
    },
    Person{
        Name: "hamilton",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Margaret_Hamilton_(scientist)",},
    },
    Person{
        Name: "haslett",
    ...
    Person{
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Martin_Hellman",},
    },
    Person{
        Name: "heisenberg",
        Description: "Werner Heisenberg was a founding father of quantum mechanics.",
        Url: []string{"https://en.wikipedia.org/wiki/Werner_Heisenberg",},
    },
    Person{
        Name: "hermann",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Grete_Hermann",},
    },
    Person{
        Name: "herschel",
        Description: "Caroline Lucretia Herschel. German astronomer and discoverer of several comets.",
        Url: []string{"https://en.wikipedia.org/wiki/Caroline_Herschel",},
    },
    Person{
        Name: "hertz",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Heinrich_Hertz",},
    },
    Person{
        Name: "heyrovsky",
        Description: "Jaroslav Heyrovský was the inventor of the polarographic method, father of the electroanalytical method, and recipient of the Nobel Prize in 1959. His main field of work was polarography.",
        Url: []string{"https://en.wikipedia.org/wiki/Jaroslav_Heyrovsk%C3%BD",},
    },
    Person{
        Name: "hodgkin",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Dorothy_Hodgkin",},
    },
    Person{
        Name: "hofstadter",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Douglas_Hofstadter",},
    },
    Person{
        Name: "hoover",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Erna_Schneider_Hoover",},
    },
    Person{
        Name: "hopper",
    ...
    Person{
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Frances_Hugle",},
    },
    Person{
        Name: "hypatia",
    ...
    Person{
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Mary_Jackson_(engineer)",},
    },
    Person{
        Name: "jang",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Jang_Yeong-sil",},
    },
    Person{
        Name: "jemison",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Mae_Jemison",},
    },
    Person{
        Name: "jennings",
        Description: "Betty Jennings. One of the original programmers of the ENIAC.",
        Url: []string{"https://en.wikipedia.org/wiki/ENIAC", "https://en.wikipedia.org/wiki/Jean_Bartik",},
    },
    Person{
        Name: "jepsen",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Mary_Lou_Jepsen",},
    },
    Person{
        Name: "johnson",
        Description: "Katherine Coleman Goble Johnson. American physicist and mathematician contributed to the NASA.",
        Url: []string{"https://en.wikipedia.org/wiki/Katherine_Johnson",},
    },
    Person{
        Name: "joliot",
        Description: "Irène Joliot-Curie. French scientist who was awarded the Nobel Prize for Chemistry in 1935. Daughter of Marie and Pierre Curie.",
        Url: []string{"https://en.wikipedia.org/wiki/Ir%C3%A8ne_Joliot-Curie",},
    },
    Person{
        Name: "jones",
        Description: "Karen Spärck Jones came up with the concept of inverse document frequency, which is used in most search engines today.",
        Url: []string{"https://en.wikipedia.org/wiki/Karen_Sp%C3%A4rck_Jones",},
    },
    Person{
        Name: "kalam",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/A._P._J._Abdul_Kalam",},
    },
    Person{
        Name: "kapitsa",
        Description: "Sergey Petrovich Kapitsa (Russian: Серге́й Петро́вич Капи́ца; 14 February 1928 – 14 August 2012) was a Russian physicist and demographer. He was best known as host of the popular and long-running Russian scientific TV show, Evident, but Incredible. His father was the Nobel laureate Soviet-era physicist Pyotr Kapitsa, and his brother was the geographer and Antarctic explorer Andrey Kapitsa.",
        Url: []string{"https://en.wikipedia.org/wiki/Sergey_Kapitsa",},
    },
    Person{
        Name: "kare",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Susan_Kare",},
    },
    Person{
        Name: "keldysh",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Mstislav_Keldysh",},
    },
    Person{
        Name: "keller",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Mary_Kenneth_Keller",},
    },
    Person{
        Name: "kepler",
        Description: "Johannes Kepler, German astronomer known for his three laws of planetary motion",
        Url: []string{"https://en.wikipedia.org/wiki/Johannes_Kepler",},
    },
    Person{
        Name: "khayyam",
    ...
    Person{
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Donald_Knuth",},
    },
    Person{
        Name: "kowalevski",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Sofia_Kovalevskaya",},
    },
    Person{
        Name: "lalande",
        Description: "Marie-Jeanne de Lalande. French astronomer, mathematician and cataloguer of stars",
        Url: []string{"https://en.wikipedia.org/wiki/Marie-Jeanne_de_Lalande",},
    },
    Person{
        Name: "lamarr",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Hedy_Lamarr",},
    },
    Person{
        Name: "lamport",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Leslie_Lamport",},
    },
    Person{
        Name: "leakey",
        Description: "Mary Leakey. British paleoanthropologist who discovered the first fossilized Proconsul skull",
        Url: []string{"https://en.wikipedia.org/wiki/Mary_Leakey",},
    },
    Person{
        Name: "leavitt",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Henrietta_Swan_Leavitt",},
    },
    Person{
        Name: "lederberg",
        Description: "Esther Miriam Zimmer Lederberg. American microbiologist and a pioneer of bacterial genetics.",
        Url: []string{"https://en.wikipedia.org/wiki/Esther_Lederberg",},
    },
    Person{
        Name: "lehmann",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Inge_Lehmann",},
    },
    Person{
        Name: "lewin",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Daniel_Lewin",},
    },
    Person{
        Name: "lichterman",
        Description: "Ruth Lichterman. One of the original programmers of the ENIAC.",
        Url: []string{"https://en.wikipedia.org/wiki/ENIAC", "https://en.wikipedia.org/wiki/Ruth_Teitelbaum",},
    },
    Person{
        Name: "liskov",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Barbara_Liskov",},
    },
    Person{
        Name: "lovelace",
        Description: "Ada Lovelace invented the first algorithm.",
        Url: []string{"https://en.wikipedia.org/wiki/Ada_Lovelace (thanks James Turnbull)",},
    },
    Person{
        Name: "lumiere",
        Description: "Auguste and Louis Lumière, the first filmmakers in history",
        Url: []string{"https://en.wikipedia.org/wiki/Auguste_and_Louis_Lumi%C3%A8re",},
    },
    Person{
        Name: "mahavira",
        Description: "Mahavira. Ancient Indian mathematician during 9th century AD who discovered basic algebraic identities",
        Url: []string{"https://en.wikipedia.org/wiki/Mah%C4%81v%C4%ABra_(mathematician)",},
    },
    Person{
        Name: "margulis",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Lynn_Margulis",},
    },
    Person{
        Name: "matsumoto",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Yukihiro_Matsumoto",},
    },
    Person{
        Name: "maxwell",
        Description: "James Clerk Maxwell. Scottish physicist, best known for his formulation of electromagnetic theory.",
        Url: []string{"https://en.wikipedia.org/wiki/James_Clerk_Maxwell",},
    },
    Person{
        Name: "mayer",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Maria_Mayer",},
    },
    Person{
        Name: "mccarthy",
        Description: "John McCarthy invented LISP:",
        Url: []string{"https://en.wikipedia.org/wiki/John_McCarthy_(computer_scientist)",},
    },
    Person{
        Name: "mcclintock",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Barbara_McClintock",},
    },
    Person{
        Name: "mclaren",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Anne_McLaren",},
    },
    Person{
        Name: "mclean",
        Description: "Malcolm McLean invented the modern shipping container",
        Url: []string{"https://en.wikipedia.org/wiki/Malcom_McLean",},
    },
    Person{
        Name: "mcnulty",
        Description: "Kay McNulty. One of the original programmers of the ENIAC.",
        Url: []string{"https://en.wikipedia.org/wiki/ENIAC", "https://en.wikipedia.org/wiki/Kathleen_Antonelli",},
    },
    Person{
        Name: "mendel",
        Description: "Gregor Johann Mendel. Czech scientist and founder of genetics.",
        Url: []string{"https://en.wikipedia.org/wiki/Gregor_Mendel",},
    },
    Person{
        Name: "mendeleev",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Dmitri_Mendeleev",},
    },
    Person{
        Name: "meitner",
    ...
    Person{
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Rita_Levi-Montalcini",},
    },
    Person{
        Name: "moore",
        Description: "Gordon Earle Moore. American engineer, Silicon Valley founding father, author of Moore's law.",
        Url: []string{"https://en.wikipedia.org/wiki/Gordon_Moore",},
    },
    Person{
        Name: "morse",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Samuel_Morse",},
    },
    Person{
        Name: "murdock",
        Description: "Ian Murdock, founder of the Debian project",
        Url: []string{"https://en.wikipedia.org/wiki/Ian_Murdock",},
    },
    Person{
        Name: "moser",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/May-Britt_Moser",},
    },
    Person{
        Name: "napier",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/John_Napier",},
    },
    Person{
        Name: "nash",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/John_Forbes_Nash_Jr.",},
    },
    Person{
        Name: "neumann",
        Description: "John von Neumann, todays computer architectures are based on the von Neumann architecture.",
        Url: []string{"https://en.wikipedia.org/wiki/Von_Neumann_architecture",},
    },
    Person{
        Name: "newton",
        Description: "Isaac Newton invented classic mechanics and modern optics.",
        Url: []string{"https://en.wikipedia.org/wiki/Isaac_Newton",},
    },
    Person{
        Name: "nightingale",
    ...
    Person{
        ...
        Url: []string{"https://en.wikipedia.org/wiki/P%C4%81%E1%B9%87ini#Comparison_with_modern_formal_systems",},
    },
    Person{
        Name: "pare",
        Description: "Ambroise Pare invented modern surgery.",
        Url: []string{"https://en.wikipedia.org/wiki/Ambroise_Par%C3%A9",},
    },
    Person{
        Name: "pascal",
        Description: "Blaise Pascal, French mathematician, physicist, and inventor",
        Url: []string{"https://en.wikipedia.org/wiki/Blaise_Pascal",},
    },
    Person{
        Name: "pasteur",
        Description: "Louis Pasteur discovered vaccination, fermentation and pasteurization.",
        Url: []string{"https://en.wikipedia.org/wiki/Louis_Pasteur.",},
    },
    Person{
        Name: "payne",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Cecilia_Payne-Gaposchkin",},
    },
    Person{
        Name: "perlman",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Radia_Perlman",},
    },
    Person{
        Name: "pike",
        Description: "Rob Pike was a key contributor to Unix, Plan 9, the X graphic system, utf-8, and the Go programming language.",
        Url: []string{"https://en.wikipedia.org/wiki/Rob_Pike",},
    },
    Person{
        Name: "poincare",
        Description: "Henri Poincaré made fundamental contributions in several fields of mathematics.",
        Url: []string{"https://en.wikipedia.org/wiki/Henri_Poincar%C3%A9",},
    },
    Person{
        Name: "poitras",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Laura_Poitras",},
    },
    Person{
        Name: "proskuriakova",
        Description: "Tat’yana Avenirovna Proskuriakova (Russian: Татья́на Авени́ровна Проскуряко́ва) (January 23 [O.S. January 10] 1909 – August 30, 1985) was a Russian-American Mayanist scholar and archaeologist who contributed significantly to the deciphering of Maya hieroglyphs, the writing system of the pre-Columbian Maya civilization of Mesoamerica.",
        Url: []string{"https://en.wikipedia.org/wiki/Tatiana_Proskouriakoff",},
    },
    Person{
        Name: "ptolemy",
    ...
    Person{
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Srinivasa_Ramanujan",},
    },
    Person{
        Name: "ride",
    ...
    Person{
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Julia_Robinson",},
    },
    Person{
        Name: "roentgen",
        Description: "Wilhelm Conrad Röntgen. German physicist who was awarded the first Nobel Prize in Physics in 1901 for the discovery of X-rays (Röntgen rays).",
        Url: []string{"https://en.wikipedia.org/wiki/Wilhelm_R%C3%B6ntgen",},
    },
    Person{
        Name: "rosalind",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Rosalind_Franklin",},
    },
    Person{
        Name: "rubin",
        Description: "Vera Rubin. American astronomer who pioneered work on galaxy rotation rates.",
        Url: []string{"https://en.wikipedia.org/wiki/Vera_Rubin",},
    },
    Person{
        Name: "saha",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Meghnad_Saha",},
    },
    Person{
        Name: "sammet",
    ...
    Person{
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Satoshi_Nakamoto",},
    },
    Person{
        Name: "shamir",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Adi_Shamir",},
    },
    Person{
        Name: "shannon",
        Description: "Claude Shannon. The father of information theory and founder of digital circuit design theory.",
        Url: []string{"https://en.wikipedia.org/wiki/Claude_Shannon)",},
    },
    Person{
        Name: "shaw",
        Description: "Carol Shaw. Originally an Atari employee, Carol Shaw is said to be the first female video game designer.",
        Url: []string{"https://en.wikipedia.org/wiki/Carol_Shaw_(video_game_designer)",},
    },
    Person{
        Name: "shirley",
        Description: "Dame Stephanie \"Steve\" Shirley. Founded a software company in 1962 employing women working from home.",
        Url: []string{"https://en.wikipedia.org/wiki/Steve_Shirley",},
    },
    Person{
        Name: "shockley",
        Description: "William Shockley co-invented the transistor",
        Url: []string{"https://en.wikipedia.org/wiki/William_Shockley",},
    },
    Person{
        Name: "shtern",
        Description: "Lina Solomonovna Stern (or Shtern; Russian: Лина Соломоновна Штерн; 26 August 1878 – 7 March 1968) was a Soviet biochemist, physiologist and humanist whose medical discoveries saved thousands of lives at the fronts of World War II. She is best known for her pioneering work on blood–brain barrier, which she described as hemato-encephalic barrier in 1921.",
        Url: []string{"https://en.wikipedia.org/wiki/Lina_Stern",},
    },
    Person{
        Name: "sinoussi",
        Description: "Françoise Barré-Sinoussi. French virologist and Nobel Prize Laureate in Physiology or Medicine; her work was fundamental in identifying HIV as the cause of AIDS.",
        Url: []string{"https://en.wikipedia.org/wiki/Fran%C3%A7oise_Barr%C3%A9-Sinoussi",},
    },
    Person{
        Name: "snyder",
        Description: "Betty Snyder. One of the original programmers of the ENIAC.",
        Url: []string{"https://en.wikipedia.org/wiki/ENIAC", "https://en.wikipedia.org/wiki/Betty_Holberton",},
    },
    Person{
        Name: "solomon",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Cynthia_Solomon",},
    },
    Person{
        Name: "spence",
        Description: "Frances Spence. One of the original programmers of the ENIAC.",
        Url: []string{"https://en.wikipedia.org/wiki/ENIAC", "https://en.wikipedia.org/wiki/Frances_Spence",},
    },
    Person{
        Name: "stonebraker",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Michael_Stonebraker",},
    },
    Person{
        Name: "sutherland",
    ...
    Person{
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Valentina_Tereshkova",},
    },
    Person{
        Name: "tesla",
        Description: "Nikola Tesla invented the AC electric system and every gadget ever used by a James Bond villain.",
        Url: []string{"https://en.wikipedia.org/wiki/Nikola_Tesla",},
    },
    Person{
        Name: "tharp",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Marie_Tharp",},
    },
    Person{
        Name: "thompson",
        Description: "Ken Thompson, co-creator of UNIX and the C programming language",
        Url: []string{"https://en.wikipedia.org/wiki/Ken_Thompson",},
    },
    Person{
        Name: "torvalds",
        Description: "Linus Torvalds invented Linux and Git.",
        Url: []string{"https://en.wikipedia.org/wiki/Linus_Torvalds",},
    },
    Person{
        Name: "tu",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Tu_Youyou",},
    },
    Person{
        Name: "turing",
    ...
    Person{
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Var%C4%81hamihira#Contributions",},
    },
    Person{
        Name: "vaughan",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Dorothy_Vaughan",},
    },
    Person{
        Name: "villani",
        Description: "Cédric Villani. French mathematician, won Fields Medal, Fermat Prize and Poincaré Price for his work in differential geometry and statistical mechanics.",
        Url: []string{"https://en.wikipedia.org/wiki/C%C3%A9dric_Villani",},
    },
    Person{
        Name: "visvesvaraya",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Visvesvaraya",},
    },
    Person{
        Name: "volhard",
        Description: "Christiane Nüsslein-Volhard. German biologist, won Nobel Prize in Physiology or Medicine in 1995 for research on the genetic control of embryonic development.",
        Url: []string{"https://en.wikipedia.org/wiki/Christiane_N%C3%BCsslein-Volhard",},
    },
    Person{
        Name: "wescoff",
        Description: "Marlyn Wescoff. One of the original programmers of the ENIAC.",
        Url: []string{"https://en.wikipedia.org/wiki/ENIAC", "https://en.wikipedia.org/wiki/Marlyn_Meltzer",},
    },
    Person{
        Name: "wilbur",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Sylvia_Wilbur",},
    },
    Person{
        Name: "wiles",
        Description: "Andrew Wiles. Notable British mathematician who proved the enigmatic Fermat's Last Theorem",
        Url: []string{"https://en.wikipedia.org/wiki/Andrew_Wiles",},
    },
    Person{
        Name: "williams",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Roberta_Williams",},
    },
    Person{
        Name: "williamson",
    ...
    Person{
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Wright_brothers",},
    },
    Person{
        Name: "wu",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Chien-Shiung_Wu",},
    },
    Person{
        Name: "yalow",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Rosalyn_Sussman_Yalow",},
    },
    Person{
        Name: "yonath",
        ...
        Url: []string{"https://en.wikipedia.org/wiki/Ada_Yonath",},
    },
    Person{
        Name: "zhukovsky",
        Description: "Nikolay Yegorovich Zhukovsky (Russian: Никола́й Его́рович Жуко́вский, January 17 1847 – March 17, 1921) was a Russian scientist, mathematician and engineer, and a founding father of modern aero- and hydrodynamics. Whereas contemporary scientists scoffed at the idea of human flight, Zhukovsky was the first to undertake the study of airflow. He is often called the Father of Russian Aviation.",
        Url: []string{"https://en.wikipedia.org/wiki/Nikolay_Yegorovich_Zhukovsky",},
    },
}
